...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("demo_workflow_updated.log"),
        logging.StreamHandler(sys.stdout)
    ]
)
LOGGER = logging.getLogger("DemoWorkflowUpdated")
...
def run_demo_workflow(robot_ip: str = None, arduino_port: str = None):
        ...
        "global_config": {
            "labware": {
                ...
                "strID_electrodeTipRack": {
                    ...
                    "slot": 8  # Moved from slot 10 to slot 8
                }
            },
            "instruments": {
                "pipette": {
    ...
    temp_workflow_file = "demo_workflow_updated.json"
