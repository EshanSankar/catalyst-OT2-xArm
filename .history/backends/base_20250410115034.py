...
class BaseBackend(ABC):
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.ot2: Optional[OT2Control] = None
    ...
    def connect_devices(self) -> None:
        ...
        try:
            ...
            self.logger.error(f"Failed to connect devices: {str(e)}")
    ...
    def _save_results(self, results: Dict[str, Any], experiment_id: str) -> None:
        """
    ...
    @abstractmethod
    def execute_experiment(self, unit_operation: Dict[str, Any]) -> Dict[str, Any]:
        """
        Execute an experiment.
        
        Args:
            unit_operation (Dict[str, Any]): Experiment parameters
...
class ExperimentBackend(ABC):
    """
    Abstract base class for all experiment backends.
    ...
    def __init__(
        ...
        LOGGER.info(f"{experiment_type} Backend initialized")
    ...
    def execute_experiment(self, uo: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        LOGGER.info(f"Executing {self.experiment_type} experiment with parameters: {uo}")
        
        # Validate UO type
        if uo.get("uo_type") != self.experiment_type:
            LOGGER.error(f"Invalid UO type: {uo.get('uo_type')}, expected {self.experiment_type}")
        ...
        try:
            ...
            LOGGER.error(f"Error executing {self.experiment_type} experiment: {str(e)}")
